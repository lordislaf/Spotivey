declare type SpotifyPlayerMethod<T = void> = () => Promise<T>;
export declare type SpotifyPlayerCallback = (token: string) => void;
...
export declare type WebPlaybackStatuses = 'ready' | 'not_ready';
export declare type WebPlaybackStates = 'player_state_changed';
export declare type WebPlaybackErrors = 'initialization_error' | 'authentication_error' | 'account_error' | 'playback_error';
...
export interface WebPlaybackPlayer {
    ...
    removeListener: (event: WebPlaybackErrors | WebPlaybackStates | WebPlaybackStatuses, callback?: () => void) => boolean;
